...
- `final-assembly-checklist.md`: `comment_id`, `status`, `manuscript_execution_items_done`, `response_draft_done`, `export_ready`
...
- **THEN** they must use `manuscript_execution_items_done` and `response_draft_done`
