...
<div style="white-space: pre-wrap;">Please explain why your method is better than the baseline.</div>

### reviewer_1_thread_002

- 原文（按 Primary + Supporting 聚合）:

<div style="white-space: pre-wrap;">Add an ablation study or explain the missing components.</div>

### reviewer_1_thread_003

- 原文（按 Primary + Supporting 聚合）:

<div style="white-space: pre-wrap;">Clarify data splits and reproducibility settings.</div>

### reviewer_2_thread_001

- 原文（按 Primary + Supporting 聚合）:

<div style="white-space: pre-wrap;">Please add multi-seed stability results and a figure.</div>

### reviewer_2_thread_002

- 原文（按 Primary + Supporting 聚合）:

<div style="white-space: pre-wrap;">Please justify the baseline comparison more clearly and expand the limitations discussion.</div>
