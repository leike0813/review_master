...
- 稿件修改动作: Expand the baseline-comparison explanation in the results discussion.
- 预期回复效果: Supports both reviewer threads tied to the shared baseline concern.
...
- 稿件修改动作: Add a scoped ablation rationale paragraph to the results discussion.
- 预期回复效果: Explains why a full ablation is not included while addressing the review point.

### 位置 1

- 目标位置: sections/results.tex::Ablation Placeholder::paragraph 1
...
- 稿件修改动作: Clarify data splits and seeds in the method section.
- 预期回复效果: Lets the response point to explicit reproducibility details.
...
- 稿件修改动作: Add the multi-seed stability figure and describe the trend.
- 预期回复效果: Directly answers the new-evidence request.

### 位置 1

- 目标位置: sections/results.tex::Stability Analysis::figure 2
...
- 目标位置: sections/results.tex::Stability Analysis::paragraph 2
...
- 稿件修改动作: Expand the limitations and discussion section.
- 预期回复效果: Responds to the request for a stronger discussion of limitations.

### 位置 1

- 目标位置: sections/discussion.tex::Limitations::paragraph 1
