# review-master-skill-bootstrap-contract

## Purpose

Define the minimum bootstrap instruction contract for `review-master/SKILL.md` before later changes add detailed runtime behavior.
