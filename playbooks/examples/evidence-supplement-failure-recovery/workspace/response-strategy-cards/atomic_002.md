...
- Canonical 摘要: Provide an ablation explanation.
- 所需动作: Explain the missing ablation components.

## 回复立场

- 拟采用立场: accept_and_scope
- 该立场可辩护的理由: Ablation discussion is provided as a scoped explanation.
...
- 草案文本: We added a focused ablation explanation to clarify the role of each modality without overstating the scope of the experiment.
